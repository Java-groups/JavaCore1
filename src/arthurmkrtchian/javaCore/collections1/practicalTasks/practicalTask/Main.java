...
public class Main {
    ...
    public static void run(){
        ...
        listItems.add(new ListItems(2, 1));
        listItems.add(new ListItems(8, -3));
        listItems.add(new ListItems(5, -4));
    ...
    static void insertItems(List<Integer> collection, List<ListItems> items){
